...
CCD_Intermediates::CCD_Intermediates(int number_of_electrons_, int number_of_shells_,
...
void CCD_Intermediates::DIIS(double eps, int max_it){
    //start timing:
    ...
    while(ccd_root_norm>eps && iteration < max_it){
        ...
        //cout <<"    Testing pseudo inverse:"<< endl;
        //cout << pseudoInv * B << endl;
...
void CCD_Intermediates::quasi_newton(double eps, int max_it){
    //start timing:
    std::clock_t start_ccd_function;
    start_ccd_function = std::clock();
...
void CCD_Intermediates::ccd_function(){
    //start timing:
    std::clock_t start_ccd_function;
            ...
            for(int i = 0; i < number_of_electrons; i++){
                for(int j = 0; j < number_of_electrons; j++){
                   if (i > j && a > b){
                       ...
                       for(int c = 0; c < number_of_virt_orb; c++){
                            ...
                            //Inner contraction:
                                ...
                                for(int l = 0; l < number_of_electrons; l++){
                                    for(int d = 0; d < number_of_virt_orb; d++){
                                        aux_index1 = number_of_electrons*(number_of_electrons*(number_of_virt_orb*d+c)+l)+k;
                                        aux_index2 = number_of_virt_orb*(number_of_virt_orb*(number_of_electrons*j+l)+b)+d;
                                        sum += KLCD_Block[aux_index1]*ccd_amplitudes[aux_index2];
                                    }
                                }
                                ...
                                //ccd_intermediates[number_of_electrons*c+k] = 0.5*sum ;//+ KBCJ_Block[aux_index1];
                                ccd_intermediates[number_of_electrons*c+k] = 0.5*sum+ KBCJ_Block[aux_index1];
                            }
                        }
                       ...
                       for(int k = 0; k < number_of_electrons; k++){
                            for(int c = 0; c < number_of_virt_orb; c++){
                                aux_index1 = number_of_electrons*c+k;
                                aux_index2 = number_of_virt_orb*(number_of_virt_orb*(number_of_electrons*k+i)+c)+a;
                                aux_var += ccd_intermediates[aux_index1]*ccd_amplitudes[aux_index2];
                            }
                       }
                       ...
                       for(int c = 0; c < number_of_virt_orb; c++){
                            ...
                            //Inner contraction:
                                ...
                                for(int l = 0; l < number_of_electrons; l++){
                                    for(int d = 0; d < number_of_virt_orb; d++){
                                        aux_index1 = number_of_electrons*(number_of_electrons*(number_of_virt_orb*d+c)+l)+k;
                                        aux_index2 = number_of_virt_orb*(number_of_virt_orb*(number_of_electrons*j+l)+a)+d;
                                        sum += KLCD_Block[aux_index1]*ccd_amplitudes[aux_index2];
                                    }
                                }
                       ...
                       for(int c = 0; c < number_of_virt_orb; c++){
                            ...
                            //Inner contraction:
                                ...
                                for(int l = 0; l < number_of_electrons; l++){
                                    for(int d = 0; d < number_of_virt_orb; d++){
                                        aux_index1 = number_of_electrons*(number_of_electrons*(number_of_virt_orb*d+c)+l)+k;
                                        aux_index2 = number_of_virt_orb*(number_of_virt_orb*(number_of_electrons*i+l)+b)+d;
                                        sum += KLCD_Block[aux_index1]*ccd_amplitudes[aux_index2];
                                    }
                                }
                       ...
                       for(int c = 0; c < number_of_virt_orb; c++){
                            ...
                            //Inner contraction:
                                ...
                                for(int l = 0; l < number_of_electrons; l++){
                                    for(int d = 0; d < number_of_virt_orb; d++){
                                        aux_index1 = number_of_electrons*(number_of_electrons*(number_of_virt_orb*d+c)+l)+k;
                                        aux_index2 = number_of_virt_orb*(number_of_virt_orb*(number_of_electrons*i+l)+a)+d;
                                        sum += KLCD_Block[aux_index1]*ccd_amplitudes[aux_index2];
                                    }
                                }
...
void CCD_Intermediates::corr_energy(){
    double energy = 0;
    int Index1 = 0;
    int Index2 = 0;
...
double CCD_Intermediates::getCorrEnergy(){
