#ifndef CCD_INTERMEDIATES_H
#define CCD_INTERMEDIATES_H
#include <iostream>

using namespace std;

class CCD_Intermediates
{
private:
    //System variables:
...
public:
    CCD_Intermediates(int number_of_electrons_, int number_of_shells_,
